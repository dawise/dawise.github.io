...
- [The PrintFul](https://www.theprintful.com/) - Imprimez des goodies à l'éffigie de votre marque.
- [Kymono](https://www.kymono.co/) - Vêtements aux couleurs de votre entreprise. 


## 2. Design
![](/assets/pages_images/design_cm_david_wise_dawise_paris.png)
...
- [Image Optimizer](http://www.imageoptimizer.net/Pages/Home.aspx) - Réduisez le poids de votre image.
- [Pixlr](https://pixlr.com/) - Photoshop pour les nuls. Service en ligne et gratuit. 

### Créer des citations visuelles
- [Pablo](https://buffer.com/pablo) - Creéz vos citations en 3 clics. Outil créé par l'équipe de Buffer.
- [Over](http://madewithover.com/) - Ajoutez des textes sur des images. Idéal pour les médias sociaux.

### Faire des infographies

- [Easel.ly](http://www.easel.ly/) - Créez simplement de jolies infographies.
- [Infogram](https://infogr.am/) - Même promesse : de infographies créés facilement.
- [Visage](http://visage.co/) - Nouveau venu. Jamais utilisé encore.
- [Piktochart](https://piktochart.com/) - Créez des infographies simplement. Nombreux modèles à disposition.  
...
- [Balsamiq](https://balsamiq.com/) - Permet de faire des Wireframes de page web de facon très simple et intuitive. Look "sketchy".
- [Mockflow](http://www.mockflow.com/) - Dessinez les traits de votre site ou application avec cet outil.
- [UXArchives](http://uxarchive.com/) - Source d'inspiration : permet d'avoir le parcours utilisateur (flow) d'applications populaires.
...
- [Gifs.com](https://gifs.com/) - Faites vos GIFS : copiez-collez l'URL Youtube de votre choix. Choisissez le timing. C'est déjà términé.
- [Gif You Can](http://gifyoucan.tumblr.com/) - Inspiration de GIFS pour répondre à des amis dans un contexte de tchat.
...
- [SharedCount](https://www.sharedcount.com/) - Quel score votre lien a-t-il réalisé en partage sur les réseaux sociaux ?
...
- [Optimizly](https://www.optimizely.com/) - Outil permettant de modifier sa landing page ou des pages de son site web. Permet de lancer des tests rapidement sans coder.
